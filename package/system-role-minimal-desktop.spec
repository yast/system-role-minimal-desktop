#
# spec file for package system-role-minimal-desktop
#
...
#   https://github.com/yast/system-role-minimal-desktop repository
#
...
%define role_name minimal-desktop
...
Provides:       installer_module_extension() = system-role-minimal-desktop
Provides:       extension_for_product() = SLED

%description
Meta package for minimal desktop role definition.
